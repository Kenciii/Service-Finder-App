...
const SignUp = ({ open, setOpen }) => {
  ...
  const onSubmit = async (data) => {
    let URL = null;
    if (isRegister) {
      URL = accountType === "seeker" ? "auth/register" : "serviceProvider/register";
    } else {
      URL = accountType === "seeker" ? "auth/login" : "serviceProvider/login";
    }
    ...
    try {
      ...
      if (res?.status === "failed") {
        ...
        if (isRegister) {
          alert(res?.message || "Account created successfully. Please login.");
          setIsRegister(false);
          reset(); 
          return;
        } else {
  ...
  return (
    <>
      <Transition appear show={open || true}>
