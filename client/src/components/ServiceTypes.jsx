...
const types = ["Standard", "Premium", "Budget-friendly"];

export default function ServiceTypes({ serviceTitle, setServiceTitle }) {

  return (
    <div className='w-full '>
      <Listbox value={serviceTitle} onChange={setServiceTitle}>
        <div className='relative'>
          <Listbox.Button className='relative w-full cursor-default rounded bg-white py-2.5 pl-3 pr-10 text-left focus:outline-none border border-gray-400 focus:border-blue-500 focus:ring-1 focus:ring-blue-500  sm:text-sm'>
            <span className='block truncate'>{serviceTitle}</span>
